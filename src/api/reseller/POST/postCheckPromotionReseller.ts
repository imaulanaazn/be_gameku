...
//     const promoCode = await promotionService.findAvailablePromoBypromoCode(body.promoCode, true);
//     if (!promoCode) {
...
//     const totalPrice = body.quantity * (product.resellerPrice ? product.resellerPrice : product.price);
...
// export const postCheckPromoCodeReseller: IApiRouter = {
//     path,
//     method,
//     main,
//     auth,
