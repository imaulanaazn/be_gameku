...
const main: RequestHandler = async (req, res) => {
    ...
    const dataUpdate = {
        ...
        name: body.name,
        logoUrl: uploadLogoUrl || game.logoUrl,
        isPopular: game.isPopular,
        slug: body.slug,
        logoDenom: uploadLogoDenom || game.logoDenom,
        deleted: game.deleted,
        needServerId: (body.type === "topup" && body.needServerId && body.needServerId === "true") || null,
        typeServerId: body.typeServerId ? ServerIdType[body.typeServerId.toUpperCase()] : game.typeServerId,
        type: body.type,
        voucherType: body.voucherType ? VoucherType[body.voucherType.toUpperCase()] : game.voucherType,
