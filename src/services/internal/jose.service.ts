...
import { ErrorType, JoseKey } from "@enum/index";
...
export class EncryptionService {
    ...
    constructor(type: JoseKey) {
        ...
        this.privateKey = fs.readFileSync(path.join(keyPath, `private_${type}.pem`), "utf8");
        this.publicKey = fs.readFileSync(path.join(keyPath, `public_${type}.pem`), "utf8");
    }
